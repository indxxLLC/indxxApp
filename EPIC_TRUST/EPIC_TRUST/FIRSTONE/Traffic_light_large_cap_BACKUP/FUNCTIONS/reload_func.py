...
def Reload(DATE,INDEX_ID,CALENDAR_ID):   
    ...
    if (len(CA_REQ) > 0): 
        ...
        CA_dat = CA_dat[["ACTION_ID","CORPORATE_ACTION","COUNTRY_CODE","CURRENCY","DATAPROVIDER","EX_DATE","ISIN","IDENTIFIER_NAME","MODIFY_DATE","NAME","STATUS","SYMBOL","TICKER",'VALUES']]
