...
def WEIGTHS_CSV(Weights,DATE1):
    ...
    df_csv.to_csv("E:\\EPIC_RUST\\FIRSTONE\\output\\TLLCGI_"+DATE1+".csv",index = False)
    

#fromaddr = "stipirneni@indxx.com" #Should be replaced by Prod mail_Id
#toaddr = ["vvardhan@indxx.com"] # List of Handling team emails
#toaddr = ["pavank@indxx.com"] # List of Handling team emails
...
def error_msg(e,msg):
    ...
    mailserver.ehlo()
    mailserver.starttls()
    mailserver.login('notifications@indxx.com', base64.b64decode('VHJhZmZpY0AxMjM0').decode('utf-8')) #Password for prod email.
    fromaddr = 'notifications@indxx.com'
    #toaddr = ["stipirneni@indxx.com","indexoperations@indxx.com"]
    #covert at this site http://www.utilities-online.info/base64/#.Xg2Jp0czaUk
    toaddr = ['pavank@indxx.com',]
    if msg == '': 
        mailserver.sendmail(fromaddr,toaddr,message) 
    else:
        msg1 = 'Subject: {} \n\n Exec at: \n\t{} \n\n{}'.format('Custom Message', exec_time, msg)
...
def success_send_attach(file_path):
    msg = MIMEMultipart()
    msg['Subject'] = "Weights File for Epic Trust-TLLCGI index" 
#    file_path = "C:\\Users\\V Vardhan\\Desktop\\EPICTRUST\\EXPOSURE DATA\\ABCD_LIVE_31-12-2009.csv"
    ...
    ########    Mail Body
    content = "Hi Team, \n\nPFA weights file for Epic Trust- TLLCGI index. Kindly upload it to calculation engine. \n\nThanks, \nIndxx Team "                      
    ...
    server.starttls()
    fromaddr = 'notifications@indxx.com'
    #toaddr = ["pavank@indxx.com",'indexoperations@indxx.com']
    toaddr = ['pavank@indxx.com']
    server.login(fromaddr, base64.b64decode('VHJhZmZpY0AxMjM0NQ==').decode('utf-8'))
