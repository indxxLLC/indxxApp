...
SECRET_KEY = 'l#(k34e##ef+on58@d1se$_*07mun($=kzrq90ecall8j0(yl+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
TEMPLATE_DEBUG = DEBUG
if DEBUG is False:
    ALLOWED_HOSTS = ['192.168.1.115','127.0.0.1','192.168.1.137','192.168.1.151']
...
CRONJOBS = [
    ('*/5 * * * *', 'automation.cron.my_scheduled_job')
]
