...
def report_generate(request):
	...
	if request.method == 'POST':
		...
		if(cname1 == "" and month =="" and month2 =="" and (sel_type1!="")):
					...
					if(month!="" and month2==""):
						...
						if(sel_type1 =="effective"):
							...
							for i in range(0,num_month):
								...
								if from_month <= e_date and month1!="":
							...
							for i in range(0,num_month_review):
								...
								if from_month <= e_date_review and month1_review!="":
									flag=1
							...
							for i in range(0,num_month_rebal):
								...
								if from_month <= e_date_rebal and month1_rebal!="":
									flag=1
							...
							for i in range(0,num_month):
								...
								if(from_month <= e_date or from_month<= s_date or from_month<= f_date or from_month<=a_date or from_month<=cl_date or from_month<=c_date  or from_month<=com_date or from_month <= qc_date or from_month <= comm_cal_date):
									#or from_month <= sel_1_date or from_month <= p_date
									flag=1
									ind.Effective_Date_rec = ind.Effective_Date_rec + date1 + "\n"
									ind.Selection_Date_Cycle_2_rec = ind.Selection_Date_Cycle_2_rec + sel_date + "\n"
									ind.Selection_Date_Cycle_1_rec = ind.Selection_Date_Cycle_1_rec + selection_date1 + "\n"
							...
							for i in range(0,num_month_rebal):
								...
								cal_month_rebal = month1_rebal
								month1_rebal= month1_rebal+gap_rebal
								if(from_month <= e_date_rebal or from_month<= f_date_rebal or from_month<=a_date_rebal or from_month<=cl_date_rebal or from_month<= qc_date_rebal
									):
									ind.Effective_Date_re = ind.Effective_Date_re + date1_rebal + "\n"
									ind.QC_Date_re = ind.QC_Date_re + Quality_date_rebal + "\n"
							...
							for i in range(0,num_month_review):
								...
								if(from_month <= e_date_review or from_month<= s_date_review or from_month<= f_date_review or from_month<=a_date_review or from_month<=cl_date_review
									 or from_month<=com_date_review or from_month<= qc_date_review or from_month<= comm_cal_date_review):
