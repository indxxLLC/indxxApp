...
function ISINvalidation(element)
{
	...
	{
		alert('Length of ISIN must be 12.');
		element.value="";
	}
...
function BBGvalidation(element){
	...
	{
		alert('Maximum length of BBG Ticker must be 10.');
		element.value="";
	}
}
...
{           var check2 = document.getElementById('check2');
			...
			if(((etf.value == "No") && (prd_status.value == 'Licensed and Launched')) || ((etf.value == "No") && (prd_status.value == 'Launched')))
			{
				alert('Please select ETF Launched "yes".');
				flag=1;
			}
            ...
            if(flag==0){
				...
				if(document.getElementById('check1').checked==false){		
					var redOptions = document.querySelectorAll('option.myoption'),
					i = 0,
					...
					for (; i < len; i++) {
						redOptions[i].disabled = false;
					}
				 }
				 if(document.getElementById('check1').checked==false){		
					document.getElementById('mnl_eff_date').readOnly= true;
					document.getElementById('mnl_comm_cal_date').readOnly= true;
					document.getElementById('mnl_pb_announce_date').readOnly= true;
					document.getElementById('mnl_client_comm_date').readOnly= true;
					document.getElementById('mnl_freeze_date').readOnly= true;
					document.getElementById('mnl_prelim_date').readOnly= true;
					document.getElementById('mnl_sel2_date').readOnly= true;
					document.getElementById('mnl_qc_date').readOnly= true;
					document.getElementById('mnl_cmp_date').readOnly= true;
					document.getElementById('mnl_sel1_date').readOnly= true;

					
	              }
				 else{
					 document.getElementById('mnl_eff_date').readOnly= false;
					 document.getElementById('mnl_comm_cal_date').readOnly= false;
					document.getElementById('mnl_pb_announce_date').readOnly= false;
					document.getElementById('mnl_client_comm_date').readOnly= false;
					document.getElementById('mnl_freeze_date').readOnly= false;
					document.getElementById('mnl_prelim_date').readOnly= false;
					document.getElementById('mnl_qc_date').readOnly= false;
					document.getElementById('mnl_sel2_date').readOnly= false;
					document.getElementById('mnl_cmp_date').readOnly=false;
					document.getElementById('mnl_sel1_date').readOnly=false;
				 }
                }
	  ...
	  //|| (icom.style.display == 'block' && icom.value == '')
	   ...
	   ||(sel_2.style.display == 'block' && sel_2.value == ''))
	   {
		...
		if(document.getElementById('check2').checked==false){		
					var redOptions = document.querySelectorAll('option.myoption1'),
					i = 0,
					len = redOptions.length;
	 ...
	 if (check1.checked ==true){
		 ...
		 || (fre_date!= null && fre_date.value == '') 
		   ||(ann_date!= null && ann_date.value == '') || (cl_date!= null && cl_date.value == '') || (com_cal!= null && com_cal.value == ''))
		   {
			...
			$("#bottom1").addClass("showDIV");
			if(document.getElementById('check2').checked==false){		
					document.getElementById('mnl_eff_date_rebal').readOnly= true;
					document.getElementById('mnl_freeze_date_rebal').readOnly= true;
					document.getElementById('mnl_qc_date_rebal').readOnly= true;
					document.getElementById('mnl_pb_announce_date_rebal').readOnly= true;
					document.getElementById('mnl_client_comm_date_rebal').readOnly= true;
					document.getElementById('mnl_comm_cal_date_rebal').readOnly= true;
					
	              }
				 else{
					 document.getElementById('mnl_eff_date_rebal').readOnly= false;
					document.getElementById('mnl_freeze_date_rebal').readOnly= false;
					document.getElementById('mnl_qc_date_rebal').readOnly= false;
					document.getElementById('mnl_pb_announce_date_rebal').readOnly= false;
					document.getElementById('mnl_client_comm_date_rebal').readOnly= false;
					document.getElementById('mnl_comm_cal_date_rebal').readOnly=false;
				 }
		   }
...
function showTab4()
{
            ...
            if(flag==0){
				...
				if(document.getElementById('check3').checked==false){		
					var redOptions = document.querySelectorAll('option.myoption2'),
					i = 0,
					len = redOptions.length;
				 ...
				 if(document.getElementById('check3').checked==false){		
					document.getElementById('mnl_eff_date_review').readOnly= true;
					document.getElementById('mnl_sel2_date_review').readOnly= true;
					document.getElementById('mnl_qc_date_review').readOnly= true;
					document.getElementById('mnl_freeze_date_review').readOnly= true;
					document.getElementById('mnl_pb_announce_date_review').readOnly= true;
					document.getElementById('mnl_client_comm_date_review').readOnly= true;
					document.getElementById('mnl_comm_cal_date_review').readOnly= true;
				
					
	              }
				 else{
					document.getElementById('mnl_eff_date_review').readOnly= false;
					document.getElementById('mnl_sel2_date_review').readOnly= false;
					document.getElementById('mnl_qc_date_review').readOnly= false;
					document.getElementById('mnl_freeze_date_review').readOnly= false;
					document.getElementById('mnl_pb_announce_date_review').readOnly= false;
					document.getElementById('mnl_client_comm_date_review').readOnly= false;
					document.getElementById('mnl_comm_cal_date_review').readOnly=false;
